                                ...
                                <table style="background: #336f85; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                    ...
                                    <tr>
                                        ...
                                        <td class="tw-card-header"
                                            ...
                                            align="center"><span
                                                style="font-weight: 600;">Confirmación de correo electrónico requerida</span></td>
                                ...
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;">Bienvenido a mi <strong>Portfolio</strong>, app que desarrollé como trabajo final de Argentina Programa, mediante el siguiente Stack tecnológico: ANGULAR + SPRINGBOOT + MYSQL</span><br/><br/><span
                                                style="font-weight: 400;">Para completar el proceso de registro, confirme su dirección de correo electrónico para activar su cuenta y asi poder ver el PORTFOLIO</span>
